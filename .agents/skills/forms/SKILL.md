...
<!-- Good: explicit label -->
<label for="email"> Email address <span class="visually-hidden">(required)</span> </label>
...
<input type="text" id="quantity" inputmode="numeric" pattern="[0-9]*" autocomplete="off" />
