...
<div id="save-tooltip" role="tooltip" hidden>Save changes to your draft</div>
```
...
<div id="delete-tip" role="tooltip" hidden>Permanently removes this item from your account</div>
```
...
<div id="info-tip" hidden>Your password must be at least 12 characters and include a number.</div>
```
