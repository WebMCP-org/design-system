...
<figure>
  ...
  <figcaption id="chart-desc">
    Annual WCAG 2.1 Level AA adoption rates from 2020 to 2024 across a sample of 10,000 public
    websites. Adoption grew steadily from 38% (2020) to 67% (2024), driven by increased procurement
    requirements.
  </figcaption>
</figure>
```
...
<!-- RIGHT -->
<img
  src="Q3-revenue-chart-final-v2.png"
