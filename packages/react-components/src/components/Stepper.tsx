...
export interface StepperNavProps extends React.ComponentPropsWithoutRef<"nav"> {}
...
export interface StepperSeparatorProps extends React.ComponentPropsWithoutRef<"span"> {}
...
export interface StepperTitleProps extends React.ComponentPropsWithoutRef<"h3"> {}
...
export interface StepperDescriptionProps extends React.ComponentPropsWithoutRef<"div"> {}
...
export interface StepperPanelProps extends React.ComponentPropsWithoutRef<"div"> {}
